...
assert.doesNotMatch(rootControls, /PodcastLauncher/, 'Podcast controls are disabled from the root header for now');
assert.doesNotMatch(appSource, /PodcastLauncher/, 'Podcast controls are disabled from the application UI for now');
